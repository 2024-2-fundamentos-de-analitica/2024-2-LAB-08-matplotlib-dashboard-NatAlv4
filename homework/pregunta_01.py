...
def pregunta_01():
    ...
    * Su código debe crear la carpeta `docs` si no existe.
    ...
    """
    """
    Crea un dashboard estático en HTML para visualizar datos de envíos.
    """
    # Rutas de archivos
...
def create_visualizations(df, output_dir):
    """
    Crea las visualizaciones y las guarda en la carpeta especificada.
    """
    # Gráfico 1: Envíos por almacén
    plt.figure()
...
def generate_html_dashboard(output_dir):
    """
    Genera un archivo HTML para el dashboard.
    """
    html_content = """
    <!DOCTYPE html>
    <html>
